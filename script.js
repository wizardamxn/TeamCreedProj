...
function showLoginForm() {
  ...
  document.addEventListener('scroll', function() {
    ...
    if (inView && !video.playing) {
        video.play();
        videoButton.style.display = 'none'; // Hide play button when video is playing
    } else if (!inView && !video.paused) {
        video.pause();
        videoButton.style.display = 'flex'; // Show play button when video is paused
    }
});
...
document.getElementById('video-button').addEventListener('click', function() {
    ...
    if (video.paused) {
        video.play();
        videoButton.style.display = 'none'; // Hide button when video is playing
    } else {
        video.pause();
        videoButton.style.display = 'flex'; // Show button when video is paused
    }
});